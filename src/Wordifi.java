...
public class Wordifi extends MIDlet implements CommandListener {
    ...
    public Alert getDoneAlert(){
            //#style mailAlert
                doneAlert =  new Alert("Done", "Level set to "+knA+".\nClick 'OK' to continue", null, AlertType.CONFIRMATION);
        return doneAlert;
    }
    ...
    public Form getWelcomeForm(){
        if (welcomeForm==null){
        //#style welcome1
            welcomeForm = new Form("WORDIFI");
        //#style welcome1
            welcomeForm.append("Welcome");
        //#style welcome2
            welcomeForm.append("to");
        //#style welcome3
            welcomeForm.append("WORDIFI");
        //#style welcome4
            welcomeForm.append("The Classic Word Game");
    ...
    public List getMenuList(){
        ...
        //#style listBackground
            menuList = new List("WORDIFI", List.IMPLICIT);
            //#style lists
            menuList.append("Play Game", null);
            //#style lists
            menuList.append("Level", null);
            //#style lists
            menuList.append("HighScore", null);
            //#style lists
            menuList.append("Instruction", null);
            //#style lists
    ...
    public Form getHighScoreForm(){
            //#style ltk
        highScoreForm = new Form("High Score");
        highScoreForm.addCommand(back);
        highScoreForm.setCommandListener(this);
        try {
            rs = RecordStore.openRecordStore("rs", true);
            //#style ltk
            highScoreForm.append(new String(rs.getRecord(1)));
            //#style ltk
            highScoreForm.append(new String(rs.getRecord(2)));
            //#style ltk
            highScoreForm.append(new String(rs.getRecord(3)));
            //#style ltk
            highScoreForm.append(new String(rs.getRecord(4)));
            //#style ltk
            highScoreForm.append(new String(rs.getRecord(5)));
    ...
    public List getLevelList(){
        if (levelList==null){
        //#style listBackground
            levelList = new List("Choose Level", List.IMPLICIT);
            //#style lists
            levelList.append("Beginner", null);
            //#style lists
            levelList.append("Professional", null);
            //#style lists
            levelList.append("Expert", null);
            //#style lists
            levelList.append("Extreme", null);
    ...
    public Form getGameForm(){
        ...
        //#style sav
        gameForm.append("Time Remaining: "+Integer.toString(time));
        //#style question
        gameForm.append(questionString +"\n Score: "+ Integer.toString(score) +""
                    + "\nMultiplier: "+Integer.toString(multiplier) +/* "\n" +Integer.toString(acc2) + ""
                    + */"x\nAccuracy: " +  Integer.toString(acc) + "%");
        //#style textBox
        gameForm.append(answer);
        gameForm.append("");
        ...
        //#style sav
            gameForm.set(0, new StringItem(null, "Time Remaining: "+Integer.toString(time)));
        //#style question
...
//        acc2 =+1;
    ...
    public Form getAboutForm(){
        if (aboutForm==null){
            //#style otherForms
            aboutForm = new Form("About WORDIFI");
//            //#style welcomed
            //#style otherForms
            aboutForm.append("This game was developed by some inquisitive young minds who are"
                    ...
                    + "We can be reached on kbluee@yahoo.com and saopayne@gmail.com");
    ...
    public Form getInstructionForm(){
        if (instructionForm==null){
            ...
            instructionForm.append("This game is very SIMPLE.\n"
                    ...
                    + "Follow us on twitter @kbluue and @sao_ademola");
    ...
    public List getScoreSheet(){
        if (scoreList==null){
            //#style listScore
            scoreList = new List("Score Sheet", List.IMPLICIT);
            //#style score
            scoreList.append("Score: ", null);
            //#style scoret
            scoreList.append(Integer.toString(score), null);
            //#style score
            scoreList.append("Questions Attempted: ", null);
            //#style scoret
            scoreList.append(Integer.toString(acc2), null);
            //#style score
            scoreList.append("Correct Answers: ", null);
            //#style scoret
            scoreList.append(Integer.toString(acc1), null);
            //#style score
            scoreList.append("Accuracy: ", null);
            //#style scoret
            scoreList.append(Integer.toString(acc) + "%", null);

            //#style lists
            scoreList.append("Play Again", null);
            //#style lists
            scoreList.append("Main Menu", null);
            ...
            //#style scoret
            scoreList.set(1, Integer.toString(score), null);
            //#style scoret
            scoreList.set(3, Integer.toString(acc2), null);
            //#style scoret
            scoreList.set(5, Integer.toString(acc1), null);
            //#style scoret
            scoreList.set(7, Integer.toString(acc) + "%", null);
        }
        gameForm.set(3, new StringItem(null, ""));
        timer.cancel();
        multiplier = 1;
        ...
        if (d==levelList){
            ...
            switch (index){
                case 0:
                    words = level1;
                    knA ="Beginner";
                    display.setCurrent(getDoneAlert(),getMenuList());
                    wS = "1";
                    changeSettings();
                    break;
                case 1:
