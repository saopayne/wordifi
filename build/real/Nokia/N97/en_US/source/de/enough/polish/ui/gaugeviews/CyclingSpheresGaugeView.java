...
public class CyclingSpheresGaugeView extends ItemView {
	...
	protected void setStyle(Style style) {
		...
		//# colorObj = style.getColorProperty(262);
		//# if (colorObj != null) {
		...
		//# countObj = style.getIntProperty(264);
		//# if (countObj != null) {
		...
		//# colorObj = style.getColorProperty(263);
		//# if (colorObj != null) {
		...
		//# countObj = style.getIntProperty(265);
		//# if (countObj != null) {
		...
		//# colorObj = style.getColorProperty(273);
		//# if (colorObj != null) {
...
//# 			
		...
		//#if polish.css.gauge-cycling-spheres-highlight-center-color
		//# countObj = style.getIntProperty(288);
		//# if (countObj != null) {
			//# this.sphereHighlightCenterColor = colorObj.getColor();
//# 			
			//# if(this.sphereHighlightCount > 2)
	...
	//# {
		//# Integer countObj = style.getIntProperty(288);
		//# if (countObj != null) {
