...
implements CommandListener
{
	...
	{
		//#style alert, default
		this( title, null, null, (AlertType) null , de.enough.polish.ui.StyleSheet.defaultStyle );
	}
	...
	public Alert( String title, String alertText, Image alertImage, AlertType alertType)
	{
		//#if !polish.LibraryBuild
			//#style alert, default
			this( title, alertText, alertImage, alertType , de.enough.polish.ui.StyleSheet.defaultStyle );
		//#else
...
//	}
	...
	public void setStyle(Style style) {
		...
		//#if polish.css.show-dismiss-command
			//# Boolean showDismissCommandBool = style.getBooleanProperty(112);
		...
		//#endif
		//#if polish.css.content-style
			//# Style contentStyleObj = (Style) style.getObjectProperty(297);
