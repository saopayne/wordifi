	...
	//#if polish.css.animations
		...
		//# {
			//#if polish.css.background-web20-color
				//# Color bgCol = style.getColorProperty(28641);
				//# if (bgCol != null) {
					//# this.color = bgCol.getColor();
				//# }
			//#endif
			//#if polish.css.background-web20-arc
				//# Integer arcInt = style.getIntProperty(-1);
				//# if (arcInt != null) {
