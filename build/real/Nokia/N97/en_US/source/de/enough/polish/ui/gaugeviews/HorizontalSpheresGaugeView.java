...
public class HorizontalSpheresGaugeView extends ItemView {
	...
	protected void setStyle(Style style) {
		...
		//# colorObj = style.getColorProperty(267);
		//# if (colorObj != null) {
		...
		//# countObj = style.getIntProperty(269);
		//# if (countObj != null) {
		...
		//# colorObj = style.getColorProperty(268);
		//# if (colorObj != null) {
		...
		//# countObj = style.getIntProperty(270);
		//# if (countObj != null) {
		...
		//# colorObj = style.getColorProperty(274);
		//# if (colorObj != null) {
...
//# 			
		...
		//# countObj = style.getIntProperty(271);
		//# if (countObj != null) {
	...
	//# {
		...
		//# Integer countObj = style.getIntProperty(290);
		//# if (countObj != null) {
