...
import de.enough.polish.ui.AlertType; import de.enough.polish.ui.StyleSheet;
	...
	public void commandAction(Command command, Item item) {
		...
		if (command == RssTagHandler.CMD_RSS_ITEM_SELECT) {
			...
			if (rssItem != null && StyleSheet.display != null) {
				...
				Alert alert = new Alert( rssItem.getTitle(), rssItem.getDescription(), null, AlertType.INFO, de.enough.polish.ui.StyleSheet.rssdescriptionalertStyle );
