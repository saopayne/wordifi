...
public class GradientVerticalBackground  extends Background {
	...
	//# {
		...
		//#if polish.css.background-vertical-gradient-top-color
			//# Color tbgColor = style.getColorProperty(-31489);
			//# if (tbgColor != null) {
		...
		//#if polish.css.background-vertical-gradient-bottom-color
			//# Color bbgColor = style.getColorProperty(30371);
			//# if (bbgColor != null) {
		...
		//#if polish.css.background-vertical-gradient-start
			//# Dimension startObj = (Dimension) style.getObjectProperty(-15685);
			//# if (startObj != null) {
				//# this.start = startObj;
				//# hasChanged = true;
			//# }
		...
		//#if polish.css.background-vertical-gradient-end
			//# Dimension endObj = (Dimension) style.getObjectProperty(-23508);
			//# if (endObj != null) {
				//# this.end = endObj;
				//# hasChanged = true;
			//# }
