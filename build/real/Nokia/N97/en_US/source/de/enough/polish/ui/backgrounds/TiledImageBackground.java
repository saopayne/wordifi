	...
	//#if polish.css.animations
		...
		//# {
			//#if polish.css.background-image-color
				//# Color col = style.getColorProperty(-3004);
				//# if (col != null) {
					//# this.color = col.getColor();
				//# }
			//#endif
			//#if polish.css.background-image-x-offset
				//# Dimension xOffsetInt = (Dimension) style.getObjectProperty(-15836);
				//# if (xOffsetInt != null) {
					//# this.xOffset = xOffsetInt;
				//# }
			//#endif
			//#if polish.css.background-image-y-offset
				//# Dimension yOffsetInt = (Dimension) style.getObjectProperty(-13018);
				//# if (yOffsetInt != null) {
