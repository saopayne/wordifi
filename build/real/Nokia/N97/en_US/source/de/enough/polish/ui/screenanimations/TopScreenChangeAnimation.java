...
public class TopScreenChangeAnimation extends ScreenChangeAnimation {
	...
	protected void setStyle(Style style)
	{
		...
		//#if polish.css.top-screen-change-animation-speed
			//# Integer speedInt = style.getIntProperty( 65 );
			//# if (speedInt != null ) {
		...
		//#endif
		//#if polish.css.top-screen-change-animation-move-previous
			//# Boolean movePreviousBool = style.getBooleanProperty(219);
	...
	public void paintAnimation(Graphics g) {
		...
		//#if polish.css.top-screen-change-animation-move-previous
			//# if (this.movePrevious) {
				//# y = this.screenHeight - this.currentY;
			//# }
		//#endif
		Image first;
		Image second;
		...
		g.drawImage( second, secondX, secondY - this.currentY, Graphics.TOP | Graphics.LEFT );
