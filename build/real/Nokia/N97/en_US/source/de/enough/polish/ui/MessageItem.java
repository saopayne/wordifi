...
//#endif
{
	...
	public MessageItem(String headline, String text, Style style ) {
		...
		this.headlineItem = new IconItem( headline, null , de.enough.polish.ui.StyleSheet.defaultStyle );
		//#style messagetext, default
		this.textItem = new StringItem( null, text, de.enough.polish.ui.StyleSheet.defaultStyle );
	}
