...
public class HorizontalContainerView extends ContainerView {
	...
	protected void setStyle(Style style) {
		...
		//#endif
		//#if polish.css.horizontalview-align-heights
			//# Boolean alignHeightsBools = style.getBooleanProperty(357);
