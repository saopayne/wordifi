...
public class DroppingView extends ContainerView {
	...
	protected void setStyle(Style style) {
		...
		//#ifdef polish.css.droppingview-repeat-animation
			//# Boolean repeat = style.getBooleanProperty(40);
			//# if (repeat != null) {
