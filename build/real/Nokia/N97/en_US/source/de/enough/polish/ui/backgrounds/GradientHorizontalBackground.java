...
public class GradientHorizontalBackground  extends Background {
	...
	//# {
		...
		//#if polish.css.background-horizontal-gradient-left-color
			//# Color lbgColor = style.getColorProperty(-11182);
			//# if (lbgColor != null) {
		...
		//#if polish.css.background-horizontal-gradient-right-color
			//# Color rbgColor = style.getColorProperty(6074);
			//# if (rbgColor != null) {
		...
		//#if polish.css.background-horizontal-gradient-start
			//# Dimension startObj = (Dimension) style.getObjectProperty(-8262);
			//# if (startObj != null) {
				//# this.start = startObj;
				//# hasChanged = true;
			//# }
		...
		//#if polish.css.background-horizontal-gradient-end
			//# Dimension endObj = (Dimension) style.getObjectProperty(-20102);
			//# if (endObj != null) {
				//# this.end = endObj;
				//# hasChanged = true;
			//# }
