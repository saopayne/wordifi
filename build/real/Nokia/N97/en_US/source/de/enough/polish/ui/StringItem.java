...
//				}
	...
	public void setStyle(Style style)
	{
		...
		//#endif 
		//#if tmp.useTextFilter
			//# RgbFilter[] filterObjects = (RgbFilter[]) style.getObjectProperty(422);
			...
			//# }
			//#if polish.css.text-filter-layout
				//# Integer textFilterLayoutInt = style.getIntProperty(423);
		...
		//#if polish.css.ignore-leading
			//# Boolean ignoreLeadingBoolean = style.getBooleanProperty(469);
	...
	public void setStyle(Style style, boolean resetStyle) {
		...
		//#if polish.css.text-wrap
			...
			//#endif
			//#ifdef polish.css.text-wrap-animation-direction
				//# Integer directionInt = style.getIntProperty(328);
				//# if (directionInt != null) {
					//# this.textWrapDirection = directionInt.intValue();
				//# }
			//#endif
			//#ifdef polish.css.text-wrap-animation-speed
				//# Integer animationSpeedInt = style.getIntProperty(329);
		...
		//#endif
		//#ifdef polish.css.max-lines
			//# Integer maxLinesInt = style.getIntProperty(369);
			//# if (maxLinesInt != null) {
		...
		//#endif
		//#if polish.css.text-visible
			//# Boolean textVisibleBool = style.getBooleanProperty(399);
