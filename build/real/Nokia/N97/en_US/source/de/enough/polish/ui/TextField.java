...
//#endif
{
	...
	//#ifdef polish.i18n.useDynamicTranslations
			//# /**
			 ...
			 //# */
			//# public static Command CLEAR_CMD = new Command( "Clear", CLEAR_TYPE, CLEAR_PRIORITY );
...
public static final Command CLEAR_CMD = new Command( "Clear", CLEAR_TYPE, CLEAR_PRIORITY );
	...
	//#ifndef tmp.suppressCommands
		...
		private final static int DELETE_TYPE = 
				...
				//#endif
		//#ifdef polish.i18n.useDynamicTranslations
			//# public static Command DELETE_CMD = new Command( "Delete", DELETE_TYPE, DELETE_PRIORITY );
...
//# 				
			//#ifdef polish.i18n.useDynamicTranslations
				//# public static Command ENTER_SYMBOL_CMD = new Command( "Add Symbol", Command.SCREEN, ENTER_SYMBOL_PRIORITY );
...
protected static final int KEY_CHANGE_MODE = 35;
...
//# 			
            ...
            //# } else {
            	...
            	//# if (   (fieldStyle != null) 
            		//# && (fieldStyle.getBooleanProperty(150) != null) 
            		//# && (fieldStyle.getBooleanProperty(150).booleanValue() == false) 
            	//# ) {
            		//# this.editField = new PolishOneLineField( null, getString(), max, bbStyle );
            		//#if polish.css.max-lines
            		//# fieldStyle.addAttribute(369, new Integer(1));
            		//#endif
            		//#if polish.css.max-height
            		//# if (fieldStyle.getFont() != null) {
            			//# fieldStyle.addAttribute(145, new Dimension(fieldStyle.getFont().getHeight()));
            		//# }
            		//#endif
            	//# }
            	//# else
