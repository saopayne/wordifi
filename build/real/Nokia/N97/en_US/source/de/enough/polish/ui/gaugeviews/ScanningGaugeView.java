...
//		g.drawString(""+position, x + this.width * this.number +20 ,  y + this.height * 2, 0);
	...
	protected void setStyle(Style style) {
		...
		//#endif
			...
			//# String imageURL = style.getProperty(455);
			//# if (this.selectedImageLeft == null) {
				//# try {
			...
			//# String imageRightURL = style.getProperty(457);
			//# if (this.selectedImageRight == null) {
				//# try {
			...
			//# String imageMiddleURL = style.getProperty(456);
			//# if (this.selectedImage == null) {
				//# try {
			...
			//# String imageURLBack = style.getProperty(458);
			//# if (this.selectedBackgroundImageLeft == null) {
				//# try {
			...
			//# String imageRightURLBack = style.getProperty(460);
			//# if (this.selectedBackgroundImageRight == null) {
				//# try {
			...
			//# String imageMiddleURLBack = style.getProperty(459);
			//# if (this.selectedBackgroundImage == null) {
				//# try {
