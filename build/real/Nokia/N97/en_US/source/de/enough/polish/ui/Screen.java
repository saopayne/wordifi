...
//			}
	...
	public void setStyle(Style style) {
		...
		//#if polish.css.content-background
			//# Background contBackground = (Background) style.getObjectProperty(350);
			//# if (contBackground != null) {
				//# this.contentBackground = contBackground;
			//# }
		//#endif
		//#if polish.css.content-border
			//# Border contBorder = (Border) style.getObjectProperty(351);
			//# if (contBorder != null) {
				//# this.contentBorder = contBorder;
			//# }
		//#endif
		//#if polish.css.content-bgborder
			//# Border contBgBorder = (Border) style.getObjectProperty(352);
...
//# 			
		...
		//#if tmp.usingTitle && polish.css.separate-title
			//# Boolean separateTitleBool = style.getBooleanProperty(361);
			//# if (separateTitleBool != null) {
				//# this.separateTitle = separateTitleBool.booleanValue();
			//# }
		//#endif
		//#if polish.css.subtitle-position
			//# Integer subtitlePositionInt = style.getIntProperty(365);
			//# if (subtitlePositionInt == null && this.subTitle != null && this.subTitle.style != null) {
				//# subtitlePositionInt = this.subTitle.style.getIntProperty(365);
			//# }
		...
		//#if tmp.useScrollBar && polish.css.show-scrollbar
			//# Boolean showScrollBarBool = style.getBooleanProperty(258);
		...
		//#if polish.css.repaint-previous-screen
			...
			if (repaintPreviousScreenBool != null) {
				...
				//#if !polish.Bugs.noTranslucencyWithDrawRgb && polish.css.overlay-background
				//# if (this.repaintPreviousScreen) {
					//# Background bg = (Background) style.getObjectProperty(393);
					//# if (bg != null) {
...
//# 						
		...
		//#endif
		//#if polish.css.scroll-background
			//# Boolean scrollBackgroundBool = style.getBooleanProperty(346);
		...
		//#if tmp.menuFullScreen
			...
			//#if polish.css.backgroundrange-bottom
				//# Integer backgroundRangeBottomInt = style.getIntProperty(153);
		...
		//#ifdef tmp.usingTitle
			...
			//#if polish.css.backgroundrange-top
				//# Integer backgroundRangeTopInt = style.getIntProperty(154);
		...
		//#endif
		//#if polish.css.content-expand
			//# Boolean contentExpandBool = style.getBooleanProperty(377);
		...
		//#endif
		//#if polish.css.scroll-up-background
			//# Background upBg = (Background) style.getObjectProperty(391);
			//# if (upBg != null) {
				//# this.scrollUpBackground = upBg;
			//# }
		//#endif
		//#if polish.css.scroll-down-background
			//# Background downBg = (Background) style.getObjectProperty(392);
			//# if (downBg != null) {
				//# this.scrollDownBackground = downBg;
			//# }
		//#endif
		//#if polish.css.move-scroll-backgrounds && (polish.css.scroll-up-background || polish.css.scroll-down-background)
			//# Boolean moveBool = style.getBooleanProperty(396);
			//# if (moveBool != null) {
		...
		//#if polish.css.portrait-style || polish.css.landscape-style
			//#if polish.css.landscape-style
				//# Style lsStyle = (Style) style.getObjectProperty(397);
				//# if (lsStyle != null) {
			...
			//#if polish.css.portrait-style
				//# Style ptStyle = (Style) style.getObjectProperty(398);
				//# if (ptStyle != null) {
	...
	//# {
		//# Boolean titleMenuBool = style.getBooleanProperty(386);
	...
	public void setStyle(Style style, boolean resetStyle)
	{
		if(!resetStyle && this.isInitialized) {
			...
			//#if polish.css.margin-left
				value = (Dimension) style.getObjectProperty(-2);
				if (value != null) {
				...
				//#endif
					{
						if (this.title == null || !(this.title instanceof StringItem)) {
							...
							//#else
								//#style title, default
								this.title = new StringItem( null, text , de.enough.polish.ui.StyleSheet.titleStyle );
							//#endif
	...
	public void setTitle(Item item, Style tStyle) {
		//#ifdef tmp.usingTitle
			...
			//#endif
			{
				...
				if (item != null){
					//#ifdef polish.ScreenWidth:defined
int width = 360  - (this.marginLeft + this.marginRight);
					//#else
						//# int width = this.screenWidth - (this.marginLeft + this.marginRight);
					//#endif
					if (width > 1) {
...
menuText = "Cancel";
	...
	public void addCommand(Command cmd, Style commandStyle ) {
		...
		//#else
			if (this.menuCommands == null) {
				...
				//#style menu, default
				 this.menuContainer = new Container( true , de.enough.polish.ui.StyleSheet.menuStyle );
	...
	public void addSubCommand(Command child, Command parent) {
		if (child.getStyle() != null) {
			...
			//#style menuitem, menu, default
			addSubCommand( child, parent , de.enough.polish.ui.StyleSheet.menuitemStyle );
		}
	}
