...
public class PartialSimpleBackground extends Background
{
	...
	//# {
		//#if polish.css.background-partial-color
			//# Color tbgColor = style.getColorProperty(-4152);
			//# if (tbgColor != null) {
				//# this.color = tbgColor.getColor();
			//# }
		//#endif
		//#if polish.css.background-partial-start
			//# Dimension startObj = (Dimension) style.getObjectProperty(32356);
			//# if (startObj != null) {
				//# this.start = startObj;
			//# }
		//#endif
		//#if polish.css.background-partial-end
			//# Dimension endObj = (Dimension) style.getObjectProperty(-31578);
			//# if (endObj != null) {
				//# this.end = endObj;
			//# }
		//#endif
