	...
	public void setStyle(Style style, boolean resetStyle) {
		...
		boolean hasChanged = false;
		 ...
		 //#if polish.css.text-fading-alien-glow-inner-color
			//# Color innerColorObj = style.getColorProperty( 182 );
		...
		//#if polish.css.text-fading-alien-glow-outer-out-color
			//# Color outerOutColorObj = style.getColorProperty( 183 );
		...
		//#if polish.css.text-fading-alien-glow-outer-in-color
			//# Color outerInColorObj = style.getColorProperty( 184 );
		...
		//#if polish.css.text-fading-alien-glow-delay
			//# Integer delayInt = style.getIntProperty(185);
			//# if (delayInt != null ) {
		...
		//#if polish.css.text-fading-alien-glow-steps
			//# Integer fadeTimeInt = style.getIntProperty(188);
			//# if (fadeTimeInt != null ) {
		...
		//#if polish.css.text-fading-alien-glow-duration-in
			//# Integer diInt = style.getIntProperty(186);
			//# if (diInt != null ) {
		...
		//#if polish.css.text-fading-alien-glow-duration-out
			//# Integer doInt = style.getIntProperty(187);
			//# if (doInt != null ) {
		...
		//#if polish.css.text-fading-alien-glow-mode
			//# Integer glowModeInt = style.getIntProperty(189);
			//# if (glowModeInt!=null){
