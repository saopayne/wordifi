...
public class TimeEntryItem extends StringItem
{
	...
	public void setStyle(Style style, boolean resetStyle)
	{
		...
		//#if polish.css.time-arrow-width
			//# Dimension w = (Dimension) style.getObjectProperty(380);
			//# if (w != null) {
				//# this.arrowWidth = w;
			//# }
		//#endif
	...
	public void setStyle(Style style)
	{
		...
		//#if polish.css.time-arrow-up
			//# Background bgUp = (Background) style.getObjectProperty(378);
			//# if (bgUp != null) {
				//# this.bgArrowUp = bgUp;
			//# }
		//#endif
		//#if polish.css.time-arrow-down
			//# Background bgDown = (Background) style.getObjectProperty(379);
			//# if (bgDown != null) {
