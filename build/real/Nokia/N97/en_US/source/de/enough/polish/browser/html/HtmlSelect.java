...
public class HtmlSelect
{
	...
	public ChoiceGroup getChoiceGroup()
	{
		try
		{
			...
			//#style browserOption
			ChoiceGroup choiceGroup = new ChoiceGroup(null, choiceType, de.enough.polish.ui.StyleSheet.browseroptionStyle );
			if (this.style != null) {
				choiceGroup.setStyle(this.style);
			}
			for (int i = 0; i < this.optionNames.size(); i++) {
				//#style browserOptionItem
				choiceGroup.append((String) this.optionNames.get(i), null, de.enough.polish.ui.StyleSheet.browseroptionitemStyle );
			}
