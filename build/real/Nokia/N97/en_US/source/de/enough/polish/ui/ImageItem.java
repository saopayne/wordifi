...
public class ImageItem extends Item
{
	...
	public void setStyle(Style style, boolean resetStyle) {
		...
		//#if polish.css.image-y-offset
			//# Dimension yOffsetInt = (Dimension) style.getObjectProperty(160);
			//# if (yOffsetInt != null) {
		...
		//#endif
		//#if polish.css.image-height
			//# Dimension imageHeightInt = (Dimension) style.getObjectProperty(161);
		...
		//#if polish.css.max-image-height && polish.midp2
			//# Dimension maxImageHeightDim = (Dimension) style.getObjectProperty(466);
		...
		//#endif
		//#if polish.css.max-image-width && polish.midp2
			//# Dimension maxImageWidthDim = (Dimension) style.getObjectProperty(467);
