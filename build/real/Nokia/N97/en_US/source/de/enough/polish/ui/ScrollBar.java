...
//		//#endif
	...
	public void setStyle(Style style) {
		...
		//#if polish.css.scrollbar-slider-image
			//# String url = style.getProperty(121);
			//# if (url != null) {
				//# try {
			...
			//# }
			//#if polish.css.scrollbar-slider-image-repeat
				//# Boolean repeatSliderImageBool = style.getBooleanProperty(122);
		...
		//#if polish.css.scrollbar-slider-color
			Integer sliderColorInt = style.getIntProperty(120);
		...
		//#if polish.css.scrollbar-slider-mode
			//# Integer sliderModeInt = style.getIntProperty(123);
			//# if (sliderModeInt != null) {
				//# this.sliderMode = sliderModeInt.intValue();
			//# }
		//#endif
		//#if tmp.fadeout
			//# Dimension opacityInt = (Dimension) style.getObjectProperty(31);
			//# if (opacityInt != null) {
			...
			//# if (this.startOpacity == 255) {
				...
				//# this.opacity = 254;
			//# }
			//# Boolean fadeOutBool = style.getBooleanProperty(303);
			//# if (fadeOutBool != null) {
				//# this.overlap = fadeOutBool.booleanValue();
			//# }
		//#endif
		//#if polish.css.scrollbar-slider-background
			//# Background bg = (Background) style.getObjectProperty(358);
			//# if (bg != null) {
				//# this.sliderBackground = bg;
			//# }
		//#endif
		//#if polish.css.scrollbar-slider-minimum-height
			//# Dimension sliderMinHeightInt = (Dimension)style.getObjectProperty(402);
