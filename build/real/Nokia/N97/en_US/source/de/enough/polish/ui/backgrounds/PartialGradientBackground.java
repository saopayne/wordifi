...
public class PartialGradientBackground extends Background
{
	...
	//# {
		...
		//#if polish.css.background-partial-gradient-top-color
			//# Color tbgColor = style.getColorProperty(-17983);
			//# if (tbgColor != null) {
		...
		//#if polish.css.background-partial-gradient-bottom-color
			//# Color bbgColor = style.getColorProperty(28049);
			//# if (bbgColor != null) {
		...
		//#if polish.css.background-partial-gradient-start
			//# Dimension startObj = (Dimension) style.getObjectProperty(11652);
			//# if (startObj != null) {
				//# this.start = startObj;
				//# hasChanged = true;
			//# }
		...
		//#if polish.css.background-partial-gradient-end
			//# Dimension endObj = (Dimension) style.getObjectProperty(-3395);
			//# if (endObj != null) {
				//# this.end = endObj;
				//# hasChanged = true;
			//# }
