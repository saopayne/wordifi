...
//#endif
{
	...
	public void setStyle(Style style) {
		...
		//#if polish.css.checked-style
			//# Style st = (Style) style.getObjectProperty(389);
			//# if (st != null) {
				...
				//# } else {
					...
					//# if (this.styleCheckedFocused == null) {
						...
						//# st = (Style) focStyle.getObjectProperty(389);
						//# if (st == null) {
		...
		//#ifdef polish.css.box-align
			//# Integer boxAlignInt = style.getIntProperty(421);
			//# if (boxAlignInt != null) {
