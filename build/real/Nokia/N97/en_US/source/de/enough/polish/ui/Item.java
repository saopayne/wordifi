...
//#endif
	...
	public void setStyle( Style style ) {
		...
		//#if polish.css.content-visible
			//# Boolean contentVisibleBool = style.getBooleanProperty(360);
			//# if (contentVisibleBool != null) {
				//# this.isContentVisible = contentVisibleBool.booleanValue();
			//# }
		//#endif
		//#if polish.css.bgborder
			//# Border bgBord = (Border) style.getObjectProperty(354);
		...
		//#endif
		//#if polish.css.pressed-style
			Style pressed = (Style) style.getObjectProperty(292);
			if (pressed != null) {
	...
	//# //		}
		...
		//#endif	
		//#if polish.css.background-anchor && (polish.css.background-width || polish.css.background-height)
			//# Integer bgAnchor = style.getIntProperty(341);
			//# if (bgAnchor != null) {
				//# this.backgroundAnchor = bgAnchor.intValue();
			//# }
		//#endif
		//#if polish.css.filter
			//# RgbFilter[] filterObjects = (RgbFilter[]) style.getObjectProperty(342);
		...
		//#if polish.css.inline-label
			//# Boolean inlineBool = style.getBooleanProperty(383);
			//# if (inlineBool != null) {
...
//			}
		...
		//#endif
		//#ifdef polish.css.max-width
			//# Dimension maxWidthDim  = (Dimension) style.getObjectProperty(59);
			//# if (maxWidthDim != null) {
				//# this.maximumWidth = maxWidthDim;
			//# }
		//#endif
		//#ifdef polish.css.width
			//# Dimension widthDim  = (Dimension) style.getObjectProperty(226);
			//# if (widthDim != null) {
		...
		//#ifdef polish.css.min-item-width
			//# Dimension minItemWidthDim = (Dimension) style.getObjectProperty(445);
			//# if (minItemWidthDim != null) {
				//# this.minimumItemWidth = minItemWidthDim;
			//# }
		//#endif
		//#ifdef polish.css.max-item-width
			//# Dimension maxItemWidthDim  = (Dimension) style.getObjectProperty(446);
		...
		//#ifdef polish.css.min-height
			//# Dimension minHeightDim = (Dimension) style.getObjectProperty(144);
			//# if (minHeightDim != null) {
				//# this.minimumHeight = minHeightDim;
			//# }
		//#endif
		//#ifdef polish.css.max-height
			//# Dimension maxHeightDim  = (Dimension) style.getObjectProperty(145);
		...
		//#ifdef polish.css.height
			//# Dimension heightDim  = (Dimension) style.getObjectProperty(227);
			//# if (heightDim != null) {
		...
		//#ifdef polish.css.min-item-height
			//# Dimension minItemHeightDim = (Dimension) style.getObjectProperty(447);
			//# if (minItemHeightDim != null) {
				//# this.minimumItemHeight = minItemHeightDim;
			//# }
		//#endif
		//#ifdef polish.css.max-item-height
			//# Dimension maxItemHeightDim  = (Dimension) style.getObjectProperty(448);
		...
		//#endif	
		//#if polish.css.rowspan
			//# Integer rowSpanInt = style.getIntProperty(107);
			//# if ( rowSpanInt != null ) {
		...
		//#if polish.css.visible
			//# Boolean visibleBool = style.getBooleanProperty(311);
			//# if (visibleBool != null) {
		...
		//#if polish.css.x-adjust
			//# Dimension xInt = (Dimension) style.getObjectProperty(335);
			//# if (xInt != null) {
				//# this.xAdjustment = xInt;
			//# }
		//#endif
		//#if polish.css.y-adjust
			//# Dimension yInt = (Dimension) style.getObjectProperty(336);
			//# if (yInt != null) {
		...
		//#endif
		//#if polish.css.content-x-adjust
			//# Dimension contentXInt = (Dimension) style.getObjectProperty(337);
			//# if (contentXInt != null) {
				//# this.contentXAdjustment = contentXInt;
			//# }
		//#endif
		//#if polish.css.content-y-adjust
			//# Dimension contentYInt = (Dimension) style.getObjectProperty(338);
			//# if (contentYInt != null) {
		...
		if (!resetStyle && isInitialized()) {
			//#if polish.css.background-width
				//# Dimension bgWidth = (Dimension) style.getObjectProperty(339);
				//# if (bgWidth != null) {
					//# this.backgroundWidth = bgWidth.getValue(this.originalBackgroundWidth);
				//# }
			//#endif
			//#if polish.css.background-height
				//# Dimension bgHeight = (Dimension) style.getObjectProperty(340);
				//# if (bgHeight != null) {
		...
		//#if polish.css.border-adjust
			//# Dimension borderAdjustDim = (Dimension) style.getObjectProperty(465);
		...
		//#if polish.Item.ShowCommandsOnHold
			//# if (this.commandsContainer == null) {
				...
				//#if polish.css.commands-style
					//# if (this.style != null) {
						//# Style commandsStyle = (Style) this.style.getObjectProperty(415);
				...
				//#if polish.css.child-style
					...
					//# if (this.commandsContainer.style != null) {
						//# childStyle = (Style) this.commandsContainer.style.getObjectProperty(416);
					//# }
				//#endif
//# 				
...
//		}
		...
		//#if polish.css.background-width
			...
			//# if (this.style != null) {
				//# Dimension bgWidth = (Dimension) this.style.getObjectProperty(339);
				//# if (bgWidth != null) {
		...
		//#if polish.css.background-height
			...
			//# if (this.style != null) {
				//# Dimension bgHeight = (Dimension) this.style.getObjectProperty(340);
				//# if (bgHeight != null) {
		...
		//#if polish.css.visited-style
			//# if (this.style != null && !this.hasBeenVisited) {
				//# if (this.isPressed) {
					//# notifyItemPressedEnd();
				//# }
				//# Style visitedStyle = (Style) this.style.getObjectProperty(395);
				...
				//# if (this.parent instanceof Container) {
					...
					//# visitedStyle = (Style) cont.itemStyle.getObjectProperty(395);
					//# if (visitedStyle != null) {
						//#debug
		...
		//#if polish.css.visited-style
			//# if (this.style != null && this.hasBeenVisited) {
				...
				//# for (int i = 0; i < styles.length; i++) {
					...
					//# Style visitedStyle = (Style) aStyle.getObjectProperty(395);
					...
					//# else if (cont != null && cont.itemStyle == visitedStyle) {
						...
						//# if (!oneLeft) {
							//# Style focStyle = (Style) aStyle.getObjectProperty(1);
							//# if (focStyle != null) {
								//# setStyle( focStyle );
							//# }
						//# }
	...
	public Style getFocusedStyle() {
		...
		//#if polish.css.visited-style
			//# if (this.hasBeenVisited && focStyle != null) {
				//# Style visitedStyle = (Style) focStyle.getObjectProperty(395);
				//#debug
